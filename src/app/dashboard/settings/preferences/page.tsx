...
function ToggleItem({
    ...
    return (
        <div className="flex items-center gap-4 rounded-xl border border-border bg-card p-4 transition-colors hover:bg-accent">
        ...
        >
            ...
            <div className="flex items-center gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-accent">
                    <Sliders size={20} className="text-foreground/70" />
                </div>
                <div>
            ...
            <div className="space-y-3">
                <div className="flex items-center justify-between">
                    ...
                    <button
                        ...
                        className="flex items-center gap-1.5 rounded-lg border border-border bg-card px-3 py-1.5 text-xs font-medium text-foreground/70 transition-all hover:bg-accent active:scale-[0.98] disabled:opacity-60"
                        title="Query live rate from exchange API"
                    >
                        <ArrowsClockwise
                            size={14}
                            className={isRefreshingRate ? "animate-spin text-foreground" : ""}
                        />
                ...
                <div className="rounded-2xl border border-border bg-card overflow-hidden shadow-sm">
                    {/* Live status bar */}
                    <div className="flex flex-wrap items-center justify-between gap-3 border-b border-border bg-accent/70 px-5 py-3.5">
                    ...
                    <div className="flex items-center gap-4 border-t border-border p-5">
                        <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-accent">
                            <CurrencyDollar size={18} className="text-foreground/70" />
                        </div>
                        <div className="min-w-0 flex-1">
                    ...
                    {manualRate.enabled && (
                        <motion.div
                            ...
                            className="border-t border-border bg-accent/50 px-5 py-4 space-y-3"
                        >
                            {rateError && (
                            ...
                            <div className="flex items-center gap-3">
                                <div className="flex-1 space-y-1.5">
                                    ...
                                    <input
                                        ...
                                        className="w-full rounded-xl border border-border bg-card px-4 py-2 text-sm text-foreground focus:border-ring focus:outline-none focus:ring-1 focus:ring-ring transition-colors"
                                    />
                                </div>
                                <button
                                    onClick={handleRateSave}
                                    disabled={rateSaving}
                                    className="mt-6 rounded-xl bg-primary px-5 py-2 text-sm font-semibold text-primary-foreground transition-all hover:bg-primary/90 active:scale-[0.97]"
                                >
                            ...
                            <div className="flex items-center justify-between">
                                <button
                                    ...
                                    disabled={rateSaving}
                                    className="rounded-xl border border-border bg-card px-3 py-1.5 text-xs font-semibold text-foreground/80 hover:bg-accent transition-colors"
                                >
