        ...
        >
            <div className="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p className="text-xs text-zinc-400">Configure your notification preferences</p>
                </div>
            </div>
            <div className="flex flex-col items-center justify-center rounded-2xl border border-zinc-200 bg-white py-16">
                <Bell size={40} weight="thin" className="text-zinc-300" />
                <p className="mt-3 text-sm font-semibold text-zinc-400">Coming Soon</p>
                <p className="mt-1 text-xs text-zinc-300">Email, push, and in-app notification settings.</p>
            </div>
        </motion.div>
    );
}
