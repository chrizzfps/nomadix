            ...
            >
                ...
                <div className="space-y-6">
                    ...
                    <p className="max-w-md text-lg text-zinc-400 leading-relaxed">
                        {APP_DESCRIPTION} One platform, no borders.
                    </p>
                </div>
                    ...
                    <form onSubmit={handleSignUp} className="mt-8 space-y-5">
                        ...
                        <label className="flex items-start gap-3 cursor-pointer group">
                            <div className="relative mt-0.5">
                                ...
                                />
                                <div className="h-4 w-4 rounded border border-zinc-700 bg-zinc-900 peer-checked:bg-white peer-checked:border-white transition-all" />
                                <svg
                                    className="absolute top-0 left-0 h-4 w-4 text-black opacity-0 peer-checked:opacity-100 transition-opacity"
                                    viewBox="0 0 16 16"
                                    fill="currentColor"
                                >
